...
def main(
    # fmt: off
    spacy_version: str = typer.Argument(">=3.0.0a36,<3.1.0", help="The spaCy version range"),
    spacy_streamlit_version: str = typer.Argument(">=1.0.0a2,<1.1.0", help="The version range of spacy-streamlit"),
